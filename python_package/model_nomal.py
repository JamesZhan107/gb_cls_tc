...
def generate_from_paths_and_labels(input_paths, labels, batch_size, input_size=(389,389)):
...
def main(args):
    ...
    base_model = Xception(include_top=False, weights='imagenet', input_shape=(389,389,3))
